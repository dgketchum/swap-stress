...
def plot_mae_examples(
    site_a="pretrain_2678",
    site_b="pretrain_1400",
    ...
    if checkpoint is not None:
        ...
        im = ax_a_emb.imshow(
            img_a, cmap="viridis", vmin=vmin, vmax=vmax, origin="upper"
        )
        ...
        im = ax_b_emb.imshow(
            img_b, cmap="viridis", vmin=vmin, vmax=vmax, origin="upper"
        )
